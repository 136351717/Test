...
<td align="center"><a href="${pageContext.request.contextPath }/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath }/images/编辑.png"/></a></td>
</tr>
</s:iterator>
...
<tr>
<td align="right">
   <span>当前第<s:property value="currPage"/>/<s:property value="totalPage"/>页</span>&nbsp;&nbsp;
   <span>一共<s:property value="totalCount"/>条</span>&nbsp;&nbsp;
   <span>每页<s:property value="pageSize"/>条</span>&nbsp;&nbsp;
   <span>
